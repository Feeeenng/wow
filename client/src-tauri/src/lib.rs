...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            obs::video::get_obs_video_settings,
            obs::capture::get_obs_capture_settings,
            obs::audio::get_obs_audio_inputs,
            obs::service::get_obs_record_directory,
            obs::service::open_obs_record_directory,
            obs::video::set_obs_video_settings,
            obs::service::set_obs_record_directory,
            obs::capture::configure_obs_game_capture,
            obs::audio::set_obs_audio_settings,
